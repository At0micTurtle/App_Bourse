...
ma20 = calculate_mobile_average_for_rates_data(rates, 20)
ma100 = calculate_mobile_average_for_rates_data(rates, 100)
...
for ma_item in ma_list:
    ...
    plt.plot(rates_dates, ma_values, label=f"MA{str(ma_item[1])}")
